...
function Index_two() {
  ...
  const goProtected = (path = "/available_cars") => {
    if (!isLoggedIn()) {
      navigate("/login");
      return;
    }
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <Row className="mt-4 bg-dark p-3 rounded shadow">
            ...
            <Col md={3}>
              <Button onClick={() => goProtected("/available_cars")} className="w-100 yellow-btn">Show Cars</Button>
            </Col>
          </Row>
        </Container>
      </div>
        ...
        <Container className="py-5">
          ...
          <Row className="mb-4 align-items-center">
            ...
            <Col className="text-end">
              <Button
                onClick={() => goProtected("/available_cars")}
              ...
              <div className="custom-card align-items-center">
                ...
                <div className="custom-card-body ">
                  ...
                  <div className="d-flex justify-content-between align-items-center mt-3">
                    ...
                    <Button onClick={() => goProtected("/available_cars")} className="btn btn-warning btn-sm fw-bold">
                      Details
                    </Button>
                  </div>
                  </span>
      ...
      <div className="banner-wrapper">
        ...
        {/* BUTTON ONLY */}
        <Button onClick={() => goProtected("/available_cars")} className="banner-btn">Find your subscription</Button>
      </div>
      ...
      <Row className="g-3 px-4">
        ...
        <Col md={4}>
          <div className="col-card text-white p-4 h-100 d-flex flex-column justify-content-between">
            ...
            <button onClick={() => goProtected("/available_cars")} className="btn btn-outline-light">List Your Cars</button>
          </div>
        </Col>
      </Row>
      </Container>
