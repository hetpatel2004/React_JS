    ...
    <div style={{ backgroundColor: "#221816", color: "#fff", minHeight: "100vh" }}>
        ...
        <Container>
          <Row className="align-items-center bg-dark rounded-5 g-0 overflow-hidden shadow-lg border-secondary border">
            <Col md={6} className="p-5">
              ...
              <button onClick={() => navigate("/available_cars")} className="btn btn-outline-light px-4 py-2">Explore the Fleet</button>
            </Col>
      ...
      <div className="py-5 text-center">
        <Container className="py-5 rounded-5" style={{ backgroundColor: "#E8A471", color: "#221816" }}>
          ...
          <button onClick={() => navigate("/available_cars")} className="btn btn-dark px-5 py-3 fw-bold rounded-pill">BOOK NOW</button>
        </Container>
      </div>
    </div>
  );
